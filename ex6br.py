# exercise 6.br == the second edit by VLL (or VLK, take your pick)
## This file contains errors. For a reason. See if you can find them.
## There are supposed to be three in all.
